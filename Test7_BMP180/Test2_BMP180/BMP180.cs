...
{
    //TK:
    //Copied from: https://github.com/acegrc/BMP180-Windows-IoT/blob/master/BMP180App/Bmp180Sensor.cs 
    //Added: Altitude, based on seaLevelPressure
    public class BMP180 : IDisposable
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            // Ensure we have an I2C controller
        ...
        public async Task<Bmp180SensorData> GetSensorDataAsync(Bmp180AccuracyMode oss)
        {
            ...
            // Read the Uncompensated values from the sensor.
            ...
            //Calculate and return the altitude using (simplified) the international barometric formula, https://en.wikipedia.org/wiki/Barometric_formula
            sensorData.Altitude=44330.0 * (1.0 - (double)Math.Pow(((sensorData.Pressure) / seaLevelPressure), 0.1903));
            return sensorData;
        }
