...

{
    ...
    class TCS34725
    {
        ...
        public async Task<RgbData> GetRgbDataAsync()
        {
            //Create an object to store the raw color data
            RgbData rgbData = new RgbData();

            //First get the raw color data
            ColorData colorData = await GetRawDataAsync();
        ...
        public async Task<string> GetClosestColorAsync()
        {
            //Create an object to store the raw color data
            RgbData rgbData = await GetRgbDataAsync();
